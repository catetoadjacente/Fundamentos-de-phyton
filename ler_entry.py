...
def submit():
    ...
    label_res_email.config(text=f"E-mail: {email}")
    label_res_senha.config(text=f"Senha: {senha}")
...
label_res_email = tk.Label(frame_baixo, text='', bg='lightgreen')
label_res_email.place(relx=0.45, rely=0.2) 


label_res_senha = tk.Label(frame_baixo, text='', bg='lightgreen')
label_res_senha.place(relx=0.45, rely=0.5) 
